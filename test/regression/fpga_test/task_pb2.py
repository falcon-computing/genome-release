...
_MSGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ACCRESERVE', index=10, number=10,
      options=None,
      type=None),
  ],
...
_DATAMSG_KEYVALUE = _descriptor.Descriptor(
  name='KeyValue',
  full_name='blaze.DataMsg.KeyValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='blaze.DataMsg.KeyValue.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='blaze.DataMsg.KeyValue.value', index=1,
...
_DATAMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ext_flag', full_name='blaze.DataMsg.ext_flag', index=11,
  ...
  nested_types=[_DATAMSG_KEYVALUE, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_DATAMSG_KEYVALUE.containing_type = _DATAMSG;
_DATAMSG.fields_by_name['ext_flag'].message_type = _DATAMSG_KEYVALUE
...
class DataMsg(_message.Message):
  ...
  class KeyValue(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
    DESCRIPTOR = _DATAMSG_KEYVALUE

    # @@protoc_insertion_point(class_scope:blaze.DataMsg.KeyValue)
  DESCRIPTOR = _DATAMSG
